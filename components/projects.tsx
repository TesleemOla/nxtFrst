...
export function Projects() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(135deg, #6d0456 0%, #8b1a6b 50%, #6d0456 100%)" }}
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p
            className={`text-xl text-slate-200 max-w-3xl mx-auto mb-8 transition-all duration-1000 ease-out ${
              isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          ...
          >
            <div className="relative flex-1 max-w-md">
              ...
              <Input
                ...
                className="pl-12 h-12 glass-effect border-white/20 text-white placeholder:text-slate-400 focus:border-pink-400 focus:ring-pink-400/20"
              />
            </div>
                ...
                <Button
                  ...
                  className={`transition-all duration-300 h-12 px-6 ${
                    selectedFilter === category
                      ? "bg-gradient-to-r from-pink-500 to-violet-500 hover:from-pink-600 hover:to-violet-600 text-white border-0 shadow-lg"
                      : "glass-effect border-white/20 text-slate-200 hover:bg-white/10 hover:border-pink-400 hover:text-pink-400"
                  }`}
                >
                ...
                <div className={`grid lg:grid-cols-2 gap-0 ${index % 2 === 1 ? "lg:grid-flow-col-dense" : ""}`}>
                  <div className={`relative overflow-hidden ${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
                    <img
                      ...
                      alt={project.title}
                      className={`w-full h-80 lg:h-full object-cover transition-all duration-700 ${
                  ...
                  <div className="p-10 lg:p-16 flex flex-col justify-center">
                    <div className="mb-6">
                      <div className="flex items-center gap-3 mb-4">
                        <Badge className="bg-gradient-to-r from-pink-500 to-rose-500 text-white border-0 px-4 py-2 text-sm shadow-lg">
                          <Star className="w-4 h-4 mr-2" />
                          Featured Project
                        </Badge>
                        <Badge className="glass-effect border-white/20 text-slate-200 px-3 py-1">
                          {project.category}
                        </Badge>
                      </div>
                      <h3 className="font-display text-3xl font-bold mb-4 text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all duration-500">
                        {project.title}
                      </h3>
                      <p className="text-slate-300 leading-relaxed mb-8 text-lg">{project.description}</p>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 mb-8">
                      {project.technologies.map((tech, techIndex) => (
                        <Badge
                          key={tech}
                          className={`text-sm transition-all duration-300 hover:scale-110 cursor-pointer glass-effect border-white/20 text-slate-200 hover:border-pink-400 hover:text-pink-400 ${
                    ...
                    <div className="flex gap-4">
                      <Button
                        asChild
                        className="bg-gradient-to-r from-pink-500 to-violet-500 hover:from-pink-600 hover:to-violet-600 text-white transition-all duration-300 hover:scale-105 group/btn shadow-lg hover:shadow-pink-500/25 px-8 py-3"
                      >
                      ...
                      <Button
                        variant="outline"
                        asChild
                        className="glass-effect border-white/20 text-slate-200 hover:bg-white/10 hover:border-cyan-400 hover:text-cyan-400 transition-all duration-300 hover:scale-105 group/btn px-8 py-3 bg-transparent"
                      >
        ...
        {otherProjects.length > 0 && (
          <div ref={projectsRef}>
            <h3
              className={`font-display text-3xl font-bold text-center mb-12 text-white transition-all duration-1000 ease-out ${
                isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
              }`}
                  ...
                  >
                      ...
                      <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                        <div className="flex gap-2">
                          <Button
                            size="sm"
                            asChild
                            className="bg-gradient-to-r from-pink-500 to-violet-500 text-white hover:from-pink-600 hover:to-violet-600 flex-1 shadow-lg"
                          >
                            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer">
                          ...
                          <Button
                            ...
                            variant="outline"
                            asChild
                            className="glass-effect border-white/30 text-white hover:bg-white/20 flex-1 bg-transparent"
                          >
                            <a href={project.githubUrl} target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between gap-2 mb-3">
                        <h4 className="font-display font-semibold text-xl text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all duration-300">
                          {project.title}
                        </h4>
                        <Badge className="glass-effect border-white/20 text-slate-300 text-xs">
                          {project.category}
                        </Badge>
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.slice(0, 3).map((tech) => (
                          <Badge
                            key={tech}
                            className="text-xs hover:scale-105 transition-transform glass-effect border-white/20 text-slate-300 hover:border-pink-400 hover:text-pink-400"
                          >
                            {tech}
                          </Badge>
                        ))}
                        {project.technologies.length > 3 && (
                          <Badge className="text-xs glass-effect border-white/20 text-slate-300">
                            +{project.technologies.length - 3}
                          </Badge>
                        )}
                      </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-6 p-6">
                      ...
                      <div className="md:col-span-2">
                        <div className="flex items-center gap-2 mb-2">
                          <h4 className="font-display font-semibold text-lg text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-pink-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all duration-300">
                            {project.title}
                          </h4>
                          <Badge className="glass-effect border-white/20 text-slate-300 text-xs">
                            {project.category}
                        ...
                        <div className="flex flex-wrap gap-1">
                          {project.technologies.slice(0, 4).map((tech) => (
                            <Badge key={tech} className="text-xs glass-effect border-white/20 text-slate-300">
                              {tech}
                            </Badge>
                          ))}
                        </div>
                      ...
                      <div className="flex flex-col justify-center gap-3">
                        ...
                        <div className="flex gap-2">
                          <Button
                            size="sm"
                            asChild
                            className="bg-gradient-to-r from-pink-500 to-violet-500 text-white hover:from-pink-600 hover:to-violet-600 flex-1"
                          >
                            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer">
                              <ExternalLink className="w-3 h-3 mr-1" />
                              Demo
                          ...
                          <Button
                            ...
                            variant="outline"
                            asChild
                            className="glass-effect border-white/20 text-slate-200 hover:bg-white/10 bg-transparent"
                          >
                            <a href={project.githubUrl} target="_blank" rel="noopener noreferrer">
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-16">
            ...
            <Button
              ...
              className="mt-4 glass-effect border-white/20 text-slate-200 hover:bg-white/10 hover:border-pink-400 hover:text-pink-400"
            >
              Clear Filters
            </Button>
          </div>
